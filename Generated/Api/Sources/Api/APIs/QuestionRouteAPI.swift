...
open class QuestionRouteAPI {
    ...
    /**
     ...
     - returns: QuestionServerRequest
     */
    open class func question(userId: String, byColumn: QuestionByColumn? = nil, byFields: QuestionByFields? = nil, byId: QuestionById? = nil, delete: QuestionDelete? = nil, paginate: QuestionPaginate? = nil, search: QuestionSearch? = nil, update: QuestionUpdate? = nil, upsert: QuestionUpsert? = nil, apiConfiguration: ApiAPIConfiguration = ApiAPIConfiguration.shared) async throws(ErrorResponse) -> QuestionServerRequest {
        return try await questionWithRequestBuilder(userId: userId, byColumn: byColumn, byFields: byFields, byId: byId, delete: delete, paginate: paginate, search: search, update: update, upsert: upsert, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter upsert: (form)  (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<QuestionServerRequest> 
     */
    open class func questionWithRequestBuilder(userId: String, byColumn: QuestionByColumn? = nil, byFields: QuestionByFields? = nil, byId: QuestionById? = nil, delete: QuestionDelete? = nil, paginate: QuestionPaginate? = nil, search: QuestionSearch? = nil, update: QuestionUpdate? = nil, upsert: QuestionUpsert? = nil, apiConfiguration: ApiAPIConfiguration = ApiAPIConfiguration.shared) -> RequestBuilder<QuestionServerRequest> {
        ...
        let localVariableRequestBuilder: RequestBuilder<QuestionServerRequest>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
